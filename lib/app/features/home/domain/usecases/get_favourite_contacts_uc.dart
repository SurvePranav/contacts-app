...
class GetFavouriteContactsUc implements UseCase<List<Contact>, NoParams> {
  final HomeRepository homeRepository;

  GetFavouriteContactsUc({required this.homeRepository});

  @override
  Future<Either<Failure, List<Contact>>> call(NoParams params) async {
    return await homeRepository.getFavouriteContacts();
  }
}
